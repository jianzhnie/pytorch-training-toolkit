...
class ToyModel(nn.Module):
    """A simple neural network model for demonstrating Distributed Data
    Parallel (DDP) training.
...
def demo_basic() -> None:
    ...
    try:
        print(
            f'Start running basic DDP example on rank {rank} (World Size: {world_size}).'
        )
